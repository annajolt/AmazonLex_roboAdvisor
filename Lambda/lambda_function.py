...
def recommend_portfolio(intent_request):
    ...
    if age > 65:
        return "Your age must be under 65. Please resubmit."
    if investment_amount < 5000:
        return "Your investment is to low. Investment must be equal to or more than 5000. Please resubmit."
        
    if risk_level == "None":
        "I recommend investing 100% into bonds (AGG), 0% into equities (SPY)"
    elif risk_level == "low":
        "I recommend investing 60% into bonds (AGG), 40% into equities (SPY)"
    elif risk_level == "medium":
        "I recommend investing 40% into bonds (AGG), 60% into equities (SPY)"
    else:
        "I recommend investing 20% into bonds (AGG), 80% into equities (SPY)"
